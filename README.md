...
No environment variables, Cloudflare Functions, D1 databases or R2 buckets are required. Cloudflare serves only static application files. HTTPS allows the service worker and installable PWA behaviour to work normally.
